        ...
        <div class="page page-current">
			<div class="content">
				...
				<div class="col-100" style="position:relative;height:280px;">
				 ...
				 <div class="div_height2" style="background:#ffffff;height:140px;position:absolute;top:130px;z-index:999;left:10px;right:10px;-webkit-box-shadow: 3px 3px 12px #EEEEEE;-moz-box-shadow: 3px 3px 12px #EEEEEE;box-shadow: 3px 3px 12px #EEEEEE; -moz-border-radius: 5px;-webkit-border-radius: 5px;border-radius: 5px;">
			...
			<div class="div_height2" style="background:#ffffff;left:10px;right:10px;border-radius: 5px;border:1px #FFFFFF solid;-webkit-box-shadow: 3px 3px 12px #EEEEEE;-moz-box-shadow: 3px 3px 12px #EEEEEE;box-shadow: 3px 3px 12px #EEEEEE; -moz-border-radius: 5px;-webkit-border-radius: 5px;">
