...
(function (JQ$) {
  ...
  JQ$.fn.swipeslider = function (options) {
    ...
    */
    (function init() {
      JQ$(slideContainer).css('padding-top', settings.sliderHeight);
      
      slidesWidth = slider.width();
        
      // Change slide width when window changes.
      JQ$(window).resize(resizeSlider);
      ...
      if(swipe) {
        ...
        JQ$('html').on('mouseup touchend', swipeEnd);
        JQ$('html').on('mousemove touchmove', swiping);
      }
